        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="notificacion.php">Notificacion Email</a></li>
                    <li><a class="dropdown-item" href="#">Notificacion SMS</a></li>
                </ul>
                </li>
                <li class="nav-item">
        ...
        <div class="container">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                  ...
                  <input type="radio" name="email_send" value="todos" id="todos" onclick="telefono_inv()">
                  <label for="">Individual</label>
                  <input type="radio" name="email_send" value="ind" id="ind" onclick="mostrar_telefono_inv()">
                </div>
