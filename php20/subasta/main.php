...
if (isset($_POST['send_email'])) {
  ...
  if (isset($_POST['id_aprobar_supervisor'])) {
    ...
    try {
        ...
        $mail->addAddress('edwing.sanchez@grupopcr.com.pa', 'Edwing Sanchez');
        ...
        <table id="example" class="table table-striped table-bordered text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php if($_SESSION["tipo_user"] == 'vendedor'){ ?>
                    <a type="button" class="btn btn-success btn-icon" data-bs-toggle="modal" data-bs-target="#aprobacion_supervisor" onclick="aprobar_supervisor(<?php echo $row['id']; ?>)">
                    ...
                    <?php } ?>
                      ...
                      <?php } ?>
                        <a type="submit" class="btn btn-warning btn-icon" href="adjuntos.php?id_subir=<?php echo $row['id']; ?>">
